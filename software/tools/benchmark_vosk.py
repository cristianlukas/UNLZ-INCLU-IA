...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark reproducible de Vosk con audios en espanol"
    )
    parser.add_argument(
        "--manifest",
    ...
    parser.add_argument(
        "--model-path",
        default="../assets/models/vosk/vosk-model-small-es-0.42",
        help="Ruta al modelo de Vosk en espanol",
    )
    parser.add_argument(
        "--output",
        default="./benchmark_results/vosk_es_results.json",
